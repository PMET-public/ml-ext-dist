        ...
        for (let ii = 0; ii < tiles.length; ii++) {
          if (tiles[ii] && tiles[ii].outerHTML && tiles[ii].textContent) {
            ...
            if (tiles[ii].textContent == 'Performance Insights') {
              let hrefMatch = new RegExp(' href="[^"]*" ', 'g')
  ...
  let isHeapAnalytics = window.setInterval(function () {
    if (LIB.isPropOfWindowObj('heap')) {
      ...
      let oktaEmail = LIB.getCookie('okta_email'),
        ...
        heapApp, heapArea, heapEventProps
...
let isMktPageDemoApp = window.setInterval(function () {
  if (typeof MktPage !== 'undefined') {
    ...
    let currUrlFragment, currCompFragment
