function loadData() {
  ...
  let exhaustionDate = '2016-10-21 09:14:47',
    data = {}
  ...
  if (LIB.isPropOfWindowObj('Mkt3.controller.leadNurture.NurtureDashboard.prototype.dataPrep')) {
    Mkt3.controller.leadNurture.NurtureDashboard.prototype.dataPrep = function () {
      ...
      let canvas = MktCanvas.getTabOrActive('maMarketingProgramHome'),
      ...
      if (this.summaryData && this.summaryData.tracks) {
        for (let ii = 0; ii < this.summaryData.tracks.length; ii++) {
          let trackId = this.summaryData.tracks[ii].id,
            {contents} = this.summaryData.tracks[ii]

          for (let jj = 0; jj < contents.length; jj++) {
