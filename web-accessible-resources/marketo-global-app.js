...
// eslint-disable-next-line no-var
var MARKETO_LIVE_APP_ADMIN = 'https://marketolive.com/m3/pluginv3/marketo-app-admin.js',
  MARKETO_DEMO_APP = 'https://marketolive.com/m3/pluginv3/marketo-demo-app.js',
  POD_SCRIPT = 'https://marketolive.com/m3/pluginv3/pods.js',
  DASHBOARD_DATA = 'https://marketolive.com/m3/pluginv3/marketo-dashboard-data.js',
  HEAP_ANALYTICS = 'https://marketolive.com/m3/pluginv3/heap-analytics.js',
  HEAP_ANALYTICS_DEMO = 'https://marketolive.com/m3/pluginv3/heap-analytics-demo.js',
  ...
  isMktoPageGlobal = window.setInterval(function () {
    if (LIB.isPropOfWindowObj('MktPage.savedState.custPrefix') && MktPage.userid) {
      ...
      if (accountString.search(mktoAccountStringsMatch) != -1) {
        ...
        if (MktPage.userid.toLowerCase().search(adminUserNamesMatch) != -1) {
          ...
          LIB.loadScript(MARKETO_LIVE_APP_ADMIN)
          return
        } else {
