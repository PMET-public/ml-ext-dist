...
LIB.webRequest('https://adobe.okta.com/api/internal/enduser/home', null, 'GET', true, null, function (response) {
  try {
    response = JSON.parse(response)
    oktaUser = {
      action: 'setOktaUser',
    ...
    chrome.runtime.sendMessage(LIB.getExtensionId(), oktaUser, function (response) {
