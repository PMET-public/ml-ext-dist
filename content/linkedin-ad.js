...
APP.insertAd = function (ad) {
  ...
  try {
    let coreSection = document.getElementsByClassName('core-rail')[0],
    ...
    if (topAd) {
      let actorPicture = topAd.querySelector('a[data-control-name="actor_picture"]'),
