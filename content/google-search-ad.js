...
APP.waitForResults = function (callback) {
  let isGoogleSearchDone = window.setInterval(function () {
    if (
...
APP.insertAd = function (ad) {
  let adTitleSplit = ad.title.split(/(-|\|)/),
  ...
  if (document.getElementById('tads')) {
    ...
    let adSection = document.getElementById('tads').getElementsByClassName('uEierd')[0],
      topAd = document.createElement('div')

    adHtml = '<div><div class="cUezCb luh4tb O9g5cc uUPGi"><div class="d5oMvf"><a class="Krnil" href="' +
        ad.link +
    ...
    resultsSection = document.getElementById('rso')
    ...
    for (let ii = 1; ii < adTextSplit.length; ii++) {
      adHtml +=
    ...
    for (let ii = 0; ii < adTitleSplit.length; ii++) {
      let adBottomLink = adTitleSplit[ii]
