...
APP.waitForRightCol = function (callback) {
  let isFbRightColDone = window.setInterval(function () {
...
APP.insertAd = function (ad) {
  if (document.querySelectorAll('[class=\'cxgpxx05 sj5x9vvc\']')) {
    ...
    //debugger;
    let adSection = document.querySelectorAll('[class=\'cxgpxx05 sj5x9vvc\']')[0],
...
APP.getAdInfo = function () {
  ...
  ad.title = LIB.getUrlParam('title')
  ad.link = LIB.getUrlParam('link')
  ad.linkText = LIB.getUrlParam('linkText')
  ad.text = LIB.getUrlParam('text')
  ad.image = LIB.getUrlParam('image')
