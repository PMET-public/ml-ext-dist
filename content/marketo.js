...
window.onload = function () {
  if (window.location.href.search(mktoAppDomain) != -1 && window.location.pathname != mktoLoginPathName && window.location.href.search(mktoLoginDomain) == -1) {
    ...
    if (window.location.href.search('(#AR1559A1!|#AR1544A1!|#RCM70A1!|\\?preview=true(&approved=true)?/#RCM70A1!|#AR1682A1!)') != -1) {
    ...
    window.location.href.search('^https://seo.marketo.com') != -1
  ) {
    console.log('Marketo > Location: Marketo Other App')
    LIB.loadScript('https://marketolive.com/m3/pluginv3/marketo-other-app.js')
  }
}
