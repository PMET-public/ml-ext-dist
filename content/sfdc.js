...
console.log('Dynamics > Running')

// SF > Marketo tab > MSI
// Show all engagement as 3/3 flames and starts
// Replace no activity with some more interesting moments

LIB.addStyles(`
  img[title*='Urgency:'] {content:url(https://s3.amazonaws.com/marketo-sales-insight/images/fire3_small.png)}
  img[title*='Score:'] {content:url(https://s3.amazonaws.com/marketo-sales-insight/images/star3_small.png)}
`)

let sfInterestingMoments = [
    'Signed Up for  Webinar',
    'Has Target Job Title',
    'Visited High Value Web Page',
    'Attended Up for  Webinar',
    'Filled out Contact Us Form',
    'New Drift Chatbot Conversation',
    'Stage Change: New MQL',
